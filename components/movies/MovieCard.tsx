import { CalendarIcon, Clock3Icon, FilmIcon, MapPinIcon, StarIcon, TicketIcon } from "lucide-react";
...
export function MovieCard({ movie, onClick }: MovieCardProps) {
    return (
        ...
        >
            <div
                className="flex h-48 w-full items-center justify-center bg-gradient-to-br from-slate-800 to-slate-950"
                style={
                    movie.posterUrl
                        ? {
                            backgroundImage: `linear-gradient(180deg, rgba(2,6,23,0.1), rgba(2,6,23,0.7)), url(${movie.posterUrl})`,
